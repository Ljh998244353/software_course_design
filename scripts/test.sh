...
usage() {
    cat <<'EOF'
用法:
  scripts/test.sh [all|smoke|db|module|integration|contract|risk|stress|security|auth|item|auction|bid|order|payment|review|statistics|ops|list] [额外 ctest 参数]
