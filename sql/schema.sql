...
CREATE TABLE IF NOT EXISTS item (
    ...
    trade_mode VARCHAR(32) NOT NULL DEFAULT 'MEETUP',
    location VARCHAR(128) NOT NULL DEFAULT '',
    tags_json TEXT DEFAULT NULL,
    suggested_bid_step DECIMAL(12, 2) NOT NULL DEFAULT 0.00,
    suggested_anti_sniping_window_seconds INT NOT NULL DEFAULT 0,
    suggested_extend_seconds INT NOT NULL DEFAULT 0,
